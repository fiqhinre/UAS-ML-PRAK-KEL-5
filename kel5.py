...
def result():
    ...
    similar_movies = similar_movies_cosine.head(6).index.difference(movie for movie, rating in input)
    
    return render_template("recommendation_result.html", similar_movies = similar_movies)

@app.route('/page2')
def page2():
    return render_template("moviepage2.html")

@app.route('/page3')
def page3():
    return render_template("moviepage3.html")

@app.route('/page4')
def page4():
    return render_template("moviepage4.html")

@app.route('/page5')
def page5():
    return render_template("moviepage5.html")
